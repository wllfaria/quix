...
pub const DISABLE_LINE_WRAP_FMT: []const u8 = "?7l";
pub const ENABLE_LINE_WRAP_FMT: []const u8 = "?7h";

pub const MOUSE_NORMAL_TRACKING_ENABLE_FMT: []const u8 = "?1000h";
pub const MOUSE_BUTTON_EVENT_TRACKING_ENABLE_FMT: []const u8 = "?1002h";
pub const MOUSE_ANY_EVENT_TRACKING_ENABLE_FMT: []const u8 = "?1003h";
pub const MOUSE_RXVT_TRACKING_ENABLE_FMT: []const u8 = "?1015h";
pub const MOUSE_SGR_TRACKING_ENABLE_FMT: []const u8 = "?1006h";
pub const MOUSE_NORMAL_TRACKING_DISABLE_FMT: []const u8 = "?1000l";
pub const MOUSE_BUTTON_EVENT_TRACKING_DISABLE_FMT: []const u8 = "?1002l";
pub const MOUSE_ANY_EVENT_TRACKING_DISABLE_FMT: []const u8 = "?1003l";
pub const MOUSE_RXVT_TRACKING_DISABLE_FMT: []const u8 = "?1015l";
pub const MOUSE_SGR_TRACKING_DISABLE_FMT: []const u8 = "?1006l";
